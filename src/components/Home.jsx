      ...
      <div className="container mb-5">
        <div className="row justify-content-center">
          <div className="col-lg-8">
            ...
            <h5 className="my-4">Experience and Expertise</h5>
            <article>
              <p>
              ...
              <h5 className="my-4">Automation Practice</h5>
              <p>
              ...
              <div></div>
              <h5 className="mt-4">Beyond Test Automation</h5>
              <p>
