    ...
    <div className='container mb-5 pb-5pt-4'>
      ...
      <div className='row justify-content-center'>
        <div className='col-lg-8'>
          ...
          <p>
            I hold <u>ISTQB Foundation Level</u> and <u>Scrum Master (PSM I)</u>
          ...
          <p>
            Discover my portfolio of webpages and exercises showcasing detailed
            tutorials on Cypress, Selenium, and Playwright. Visit my GitHub
            repositories to explore the code.
          </p>
